...
(function(k) {
    ...
    function kb(a, b, c) {
        var d = a._iDisplayStart,
            f = a._iDisplayLength,
            e = a.fnRecordsDisplay();
        0 === e || -1 === f ? d = 0 : "số" === typeof b ? (d = b *
            f, d > e && (d = 0)) : "first" == b ? d = 0 : "trước" == b ? (d = 0 <= f ? d - f : 0, 0 > d && (d = 0)) : "next" == b ? d + f < e && (d += f) : "last" == b ? d = Math.floor((e - 1) / f) * f : aa(a, 0, "Unknown paging action: " + b, 5);
        b = a._iDisplayStart !== d;
        a._iDisplayStart = d;
        b && (I(a, null, "trang", [a]), c && fa(a));
        return b
    }
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Không có giá trị nào phù hợp!",
            sInfo: "Hiển thị _START_ tới _END_ trong _TOTAL_ mục",
            sInfoEmpty: "Hiển thị 0 tới 0 trong 0 mục",
            sInfoFiltered: "(lọc _MAX_ trên tổng mục)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Không có giá trị nào phù hợp!"
        },
