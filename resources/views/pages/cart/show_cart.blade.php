						...
						<ul>
							...
							<?php
								...
								?>
										...
										<a style="margin-left: 160px" class="btn btn-default check_out" href="{{URL::to('/checkout')}}">Thanh toán</a>	
								<?php
									}else{
								?>
										
										<a style="margin-left: 160px" class="btn btn-default check_out" href="{{URL::to('/login-checkout')}}">Thanh toán</a>
								<?php
									}
								?>
